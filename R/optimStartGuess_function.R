...
#' Optim Starting Guess
#' 
#' This function picks the reasonable starting guess for optim, which is the mean, sd, and corr of the data ignoring censoring.
...
optimStartGuess <- function(cenData){
