...
#' @param df Degrees of Freedom with df=0 (Default) implying normal, otherwise, must be greater than 3 and an intger.
...
#'          values fo rthe parameters to be optimized over. Also note maxit here is the same as maxit in 
...
#' @return Parameter estimates MORE 
#' @export
#' @examples ADD THESE
#' 
